...
& $python -m pip install --target $target --no-deps 'openvino==2026.3.0' 'openvino-tokenizers==2026.3.0.0' 'optimum==2.3.0' 'optimum-intel==2.1.0' 'nncf==3.3.0' 'tabulate==0.10.0' 'pydot==3.0.4' 'openvino-telemetry==2025.2.0' 'ninja==1.13.0' 'psutil==7.2.2'
